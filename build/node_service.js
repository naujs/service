...
var NodeService = (function (_Component) {
  _inherits(NodeService, _Component);

  function NodeService(connector, context) {
    _classCallCheck(this, NodeService);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NodeService).call(this));
